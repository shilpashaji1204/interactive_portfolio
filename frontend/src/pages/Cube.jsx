...
// import jeffTextureImage from '../pages/sjr-logo.png';
...
const Cube = () => {
  ...
  useEffect(() => {
    ...
    torus.scale.set(0.9, 0.9, 0.9); // Increase the scale of the torus
    scene.add(torus);
    ...
    function moveCamera() {
      ...
      // Adjust the starting position of the cube on the x-axis
...
// Use this code below. It works and is recent
...
//     const torusMaterial = new THREE.MeshStandardMaterial({ color: 0xff6347 });
//     const torus = new THREE.Mesh(torusGeometry, torusMaterial);
//     torus.scale.set(.9, .9, .9); // Increase the scale of the torus
//     scene.add(torus);
